...
#### Following results are for the `ResNet34` teacher model and [this student model](https://github.com/akshaykvnit/knowledge_distillation/blob/master/models/medium_model.py) :
...
#### Following results are for the `ResNet34` teacher model and [this student model](https://github.com/akshaykvnit/knowledge_distillation/blob/master/models/small_model.py) :
...
#### Following results are for the `ResNet34` teacher model and [this student model](https://github.com/akshaykvnit/knowledge_distillation/blob/master/models/smallest_model.py) :
