python3 less_data_stagewise_medium.py -m resnet10 -d imagenette -p 10 -e 100 -s 0
python3 less_data_stagewise_medium.py -m resnet14 -d imagenette -p 10 -e 100 -s 0
python3 less_data_stagewise_medium.py -m resnet18 -d imagenette -p 10 -e 100 -s 0
python3 less_data_stagewise_medium.py -m resnet20 -d imagenette -p 10 -e 100 -s 0
python3 less_data_stagewise_medium.py -m resnet26 -d imagenette -p 10 -e 100 -s 0

python3 less_data_stagewise_medium.py -m resnet10 -d imagewoof -p 10 -e 100 -s 0
python3 less_data_stagewise_medium.py -m resnet14 -d imagewoof -p 10 -e 100 -s 0
python3 less_data_stagewise_medium.py -m resnet18 -d imagewoof -p 10 -e 100 -s 0
python3 less_data_stagewise_medium.py -m resnet20 -d imagewoof -p 10 -e 100 -s 0
python3 less_data_stagewise_medium.py -m resnet26 -d imagewoof -p 10 -e 100 -s 0

# python3 less_data_stagewise_medium.py -m resnet10 -d cifar10 -p 10 -e 100 -s 0
# python3 less_data_stagewise_medium.py -m resnet14 -d cifar10 -p 10 -e 100 -s 0
# python3 less_data_stagewise_medium.py -m resnet18 -d cifar10 -p 10 -e 100 -s 0
...
# python3 less_data_stagewise_medium.py -m resnet18 -d cifar10 -p 20 -e 100 -s 0
# python3 less_data_stagewise_medium.py -m resnet20 -d cifar10 -p 20 -e 100 -s 0
...
# python3 less_data_stagewise_medium.py -m resnet18 -d cifar10 -p 30 -e 100 -s 0
# python3 less_data_stagewise_medium.py -m resnet20 -d cifar10 -p 30 -e 100 -s 0
...
# python3 less_data_stagewise_medium.py -m resnet18 -d cifar10 -p 40 -e 100 -s 0
# python3 less_data_stagewise_medium.py -m resnet20 -d cifar10 -p 40 -e 100 -s 0
# python3 less_data_stagewise_medium.py -m resnet26 -d cifar10 -p 40 -e 100 -s 0