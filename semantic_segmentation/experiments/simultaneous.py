...
student = models.unet.Unet(hyper_params['model'], classes=hyper_params['num_classes'], encoder_weights=None).to(args.gpu)
teacher = models.unet.Unet('resnet34', classes=hyper_params['num_classes'], encoder_weights=None).to(args.gpu)
