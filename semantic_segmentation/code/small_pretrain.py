...
project_name = 'pretrain-small' + str(args.p) + '-' + hyper_params['dataset'] + '-' + hyper_params['model']
...
savename = '../saved_models/' + hyper_params['dataset'] + '/less_data/' + hyper_params['model'] + '/pretrained_' + str(args.p) + '_' + str(hyper_params['seed']) + '.pt'
highest_iou = 0
losses = []
