...
project_name = 'ld-simultaneous-' + hyper_params['model']
...
os.makedirs('../saved_models/camvid/less_data' + str(hyper_params['perc']) + '/simultaneous/' + hyper_params['model'], exist_ok = True)
savename = '../saved_models/camvid/less_data' + str(hyper_params['perc']) + '/simultaneous/' + hyper_params['model'] + '/model' + str(hyper_params['seed']) + '.pt'
highest_iou = 0
losses = []
