...
for repeated in range(0, 1) :
    ...
    for stage in range(4) :
        ...
        # in the student model.
            ...
            filename = '../saved_models/' + str(hyper_params['dataset']) + '' + str(hyper_params['student']) + '_/stage' + str(hyper_params['stage']) + '/model' + str(hyper_params['repeated']) + '.pt'
            net.load_state_dict(torch.load(filename, map_location = 'cpu'))
...
#         scheduler = torch.optim.MultiStepLR(optimizer, milestones = [80, 120], gamma = 0.1)
