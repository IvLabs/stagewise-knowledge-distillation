...
class UnetBlock(Module):
    ...
    def __init__(self, up_in_c:int, x_in_c:int, hook:Hook, final_div:bool=True, blur:bool=False, leaky:float=None,
        ...
        self.conv1 = conv_layer(ni, nf, leaky=leaky, self_attention=self_attention, **kwargs)
...
def get_unet(arch, pretrained, n_classes):
    body = create_body(arch, pretrained=pretrained)
    return DynamicUnet(encoder=body, n_classes=n_classes)